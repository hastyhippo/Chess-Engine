...
uint64_t has_attackers(Colour side, uint8_t sq, uint64_t occ, Board& b);
bool square_attacked_after_move(Colour attacker_colour, uint8_t sq, Move m, uint64_t base_occupancy, Board& b);
